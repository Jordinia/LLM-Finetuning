...
predictions = pd.read_csv("SFT0505_netpro_raw_7k_val_labelv2.csv", encoding="utf-8")
...
# Save metrics to .txt
with open("classification_report_val_SFT0505v2.txt", "w", encoding="utf-8") as f:
...
df.to_csv("classified_output_train_SFT0505.csv", index=False)
